 ...
 * @author Şevval
 */
public class DonusumMaliyetFrame extends javax.swing.JFrame {

    int cost = 0;
    //int tesisat,termostat,kombi,radyatör,boru;
    public DonusumMaliyetFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        boru_box = new javax.swing.JComboBox<>();
        ...
        tesisat_box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dönüşüm", "Hat Taşımalı Dönüşüm" }));
        ...
        jPanel1.add(tesisat_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 230, 40));
        ...
        jPanel1.add(kombi_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 350, 230, 40));

        jLabel10.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Oda Termostatı Seçimi");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 210, 230, 30));
        ...
        jPanel1.add(termostat_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, 230, 40));

        jLabel11.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Doğalgaz Tesisatı Seçimi");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 310, 230, 30));

        boru_box.setFont(new java.awt.Font("Arial", 2, 10)); // NOI18N
        boru_box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Demir Boru Tesisatı", "Esnek Boru Tesisatı" }));
        boru_box.setSelectedIndex(-1);
        boru_box.setToolTipText("");
        boru_box.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        boru_box.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boru_boxActionPerformed(evt);
            }
        });
        jPanel1.add(boru_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 350, 230, 40));
        ...
        jLabel3.setFont(new java.awt.Font("Arial", 2, 8)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Kalorifer ağızları hazır ise Dönüşüm,\nyer değiştirilecek ise Hat Taşımalı seçiniz");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 300, 40));

        jLabel9.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Kombi Dolabı");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 110, 230, 30));
        ...
        jPanel1.add(jCheckBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 150, -1, 40));
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 150, 230, 40));

        jLabel7.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Kombi Seçimi ");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, 230, 30));

        jLabel13.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Evinize Yapılacak İş");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 230, 30));
    ...
    private void boru_boxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boru_boxActionPerformed
        int a=0;
        String boru = (String) boru_box.getSelectedItem();
        switch(boru){
        ...
        cost= a;
    }//GEN-LAST:event_boru_boxActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonusumMaliyetFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DonusumMaliyetFrame().setVisible(true);
    ...
    private javax.swing.JComboBox<String> boru_box;
